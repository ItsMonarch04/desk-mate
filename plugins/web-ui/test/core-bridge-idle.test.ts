...
import { createAssistantMessageEventStream } from "../src/assistant-event-stream.ts";
import type { AssistantMessage, Model } from "../src/model-types.ts";
import {
...
const MODEL = { id: "m", name: "m", api: "anthropic", provider: "anthropic" } satisfies Model;
