...
import { modelSupportedByHarness, serviceableModelIds } from "../../model/capabilities.ts";
import { FAST_MODE_MODEL_IDS, resolveModel } from "../../model/catalog.ts";
import { defaultModelForHarness } from "../../model/defaults.ts";
import { DEFAULT_HARNESS_ID, type HarnessId, isHarnessId } from "../../model/harness-ids.ts";
...
async function getSurfaceConfig(ctx: ApiCtx): Promise<void> {
  ...
  const harnessId = deps.harnessId ?? DEFAULT_HARNESS_ID;
