      ...
      backdrop: [
        {
          ...
          authorId: "U1",
          authorName: "alice",
          text: "@deskmate can you make a weekly digest? would that be possible?",
          mentionsSelf: true,
          createdAt: 1,
        },
        {
      ...
      messages: [
        {
          ...
          authorId: "U2",
          authorName: "bob",
          text: "deskmate can you check the deploy?",
          createdAt: 2,
        },
      ],
    }),
  );
  assert.ok(prompt.includes("[2.0] bob: deskmate can you check the deploy?"), "a new message is id-prefixed");
