...
test("deployed staging smoke reaches every Fly service and the public portal", () => {
  assert.deepEqual(deployedHealthUrls("deskmate-core", "https://deskmate-portal.fly.dev"), [
    "http://127.0.0.1:8080/healthz",
    "http://deskmate-admin.internal:8080/healthz",
    "http://deskmate-web-ui.flycast/healthz",
    "http://deskmate-portal.internal:8080/healthz",
    "https://deskmate-portal.fly.dev/healthz",
  ]);
